...
- Recognize explicit GitHub-compatible HTML anchors such as `<a name="custom-anchor"></a>` when validating Markdown fragments; current validation only indexes generated heading slugs.

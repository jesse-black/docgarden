...
Codex Cloud setup currently does not require repository-specific domain allowlist additions beyond platform defaults. If that changes in the future, document the required domains in this file.
